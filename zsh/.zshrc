...
# for 42 Header:
# !!! --- megvan hogy ez miért duplán bad practice:
# !!! --- https://www.reddit.com/r/bash/comments/107aw18/screaming_case_variables_is_it_really_essential/
# !!! --- tehát hogy a POSIX szerint is, hogy NE TÖRT EL A SYSTEM cuccokat, akkor ne legyen ALL CAPS, ha application env. var...
# --- tehát lehetne hogy 42_User, 42_Mail, és kész, szépen működne...
...
# added for Claude, 2026-06-03
export PATH="$PATH:/Users/orbanbalage/.local/bin"

# OpenClaw Completion
[ -f "/Users/orbanbalage/.openclaw/completions/openclaw.zsh" ] && source "/Users/orbanbalage/.openclaw/completions/openclaw.zsh"


# Added by Antigravity CLI installer
export PATH="/Users/orbanbalage/.local/bin:$PATH"
